...
const fs = require("fs");
const friendslist = require("./../connect/friendslist.json");
const friendslist2 = require("./../connect/friendslist2.json");
...
express.get("/friends/api/public/friends/:accountId", async (req, res) => {
    ...
    if (!friendslist.find(i => i.accountId == req.params.accountId)) {
        ...
        fs.writeFileSync("./connect/friendslist.json", JSON.stringify(friendslist, null, 2));
        fs.writeFileSync("./connect/friendslist2.json", JSON.stringify(friendslist2, null, 2));
    }
