...
const functions = require("./../main/functions.js");

const port = 80;

const wss = new WebSocket({ port: port }, () => console.log("\x1b[32m[SUCCES] \x1b[33m- \x1b[0mXMPP c'est bien connecter sur le port:", port,));
wss.on("error", (err) => {
    console.log("\x1b[31m[ERROR] \x1b[33m- \x1b[0mXMPP ne c'est pas connecter.");
})
